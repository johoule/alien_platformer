...
# Images
hero_walk1 = load_image("assets/character/R2D2.png")
hero_walk2 = load_image("assets/character/R2D2.png")
hero_jump = load_image("assets/character/R2D2.png")
hero_idle = load_image("assets/character/R2D2.png")
...
block_images = {"TL": load_image("assets/tiles/top_left.png"),
                ...
                "SL": load_image("assets/tiles/space_left.png"),
                "SR": load_image("assets/tiles/space_right.png")}
